      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
        ...
        <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-[#0f0c29] via-[#1a1050] to-[#302b63] p-8 flex flex-col justify-between shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <p className="text-purple-300 text-sm mb-10 leading-relaxed">
            ...
            <div className="space-y-6">
              {contactInfo.map((item, i) => (
                <div key={i} className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-white/10 border border-white/10 flex items-center justify-center text-purple-300">
                    {item.icon}
                  </div>
                  <div>
